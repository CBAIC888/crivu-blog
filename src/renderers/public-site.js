...
export const renderNotFound = ({origin,assetVersion}) => shell({current:'',title:'找不到頁面',description:'找不到要求的內容。',path:'/404',origin,assetVersion,main:'<main class="page-main article-page"><article class="article-simple"><h1>找不到頁面</h1><p><a href="/articles">返回收錄</a></p></article></main>'});
